...
class CornersProblem(SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.cornersCheck = list(self.corners)
    ...
    def startingState(self):
        return (self.startingPosition, self.cornersVisitedList)
...
def cornersHeuristic(state, problem):
    ...
    if len(corners) != 0:
        indexList = len(corners) - 1

        problem.goal = corners[indexList]
        # print(problem.goal)
    else:
...
def foodHeuristic(state, problem):
    ...
    if len(x) != 0:
        ...
        problem.goal = x[indexList]
        # print(problem.goal)
    else:
        return heuristic.null(state, problem)

    return heuristic.manhattan(state[0], problem)  # Default to the null heuristic.
